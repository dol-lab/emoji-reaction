...
class Emoji_Reaction {
	...
	public static function get_default_emojis(): array {
		return array(
			...
			array( '🤔', __( 'thinking face', 'emoji-reaction' ) ),
			array( '😢', __( 'sad face', 'emoji-reaction' ) ),
			array( '👏', __( 'clapping hands', 'emoji-reaction' ) ),
			array( '🙏', __( 'folded hands', 'emoji-reaction' ) ),
			array( '🔥', __( 'fire', 'emoji-reaction' ) ),
			array( '✨', __( 'sparkles', 'emoji-reaction' ) ),
			array( '💯', __( 'hundred points', 'emoji-reaction' ) ),
			array( '🍎', __( 'apple', 'emoji-reaction' ) ),
			array( '🍊', __( 'orange', 'emoji-reaction' ) ),
			array( '🍓', __( 'strawberry', 'emoji-reaction' ) ),
			array( '🫐', __( 'blueberries', 'emoji-reaction' ) ),
		);
	}
